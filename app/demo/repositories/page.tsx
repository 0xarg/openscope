...
export default function Repositories() {
  ...
  const handleUntrack = (repoId: string, repoName: string) => {
    setRepos(repos.filter((repo) => repo.id !== repoId));
    toast({
      title: "Repository untracked",
      description: `${repoName} has been removed from your list.`,
    });
  };
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <Link
                      href={`/demo/repository/${repo.owner}/${repo.name}}`}
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleUntrack(repo.id, repo.name);
                      }}
