...
const generalNav = [
  ...
  { name: "Repositories", href: "/demo/repositories", icon: FolderGit2 },
  { name: "Tracked", href: "/demo/tracked", icon: BookmarkCheck },
];

const accountNav = [
  { name: "Profile", href: "/demo/profile", icon: UserCircle },
  { name: "Settings", href: "/demo/settings", icon: Settings2 },
];
